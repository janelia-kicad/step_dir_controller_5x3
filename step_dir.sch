...
ENABLE
$Comp
L step_dir_controller_5x3:26LS31 U2
U 1 1 58DB685B
P 4050 2850
...
F 2 "step_dir_controller_5x3:SOIC_16_0.154IN" H 4150 3350 60  0001 C CNN
...
ENABLE_-
$Comp
L step_dir_controller_5x3:MAX6817 U3
U 1 1 58DB7355
P 7800 5150
...
F 2 "step_dir_controller_5x3:MAX6817" H 7950 4800 60  0001 C CNN
...
$EndComp
$Comp
L step_dir_controller_5x3:0.1uF C3
U 1 1 58DB7474
P 2750 2800
...
F 2 "step_dir_controller_5x3:SM1210" H 2788 2650 30  0001 C CNN
...
Wire Wire Line
	2750 3050 2750 3000
$Comp
L step_dir_controller_5x3:0.1uF C4
U 1 1 58DB75FF
P 6750 5000
...
F 2 "step_dir_controller_5x3:SM1210" H 6788 4850 30  0001 C CNN
...
Wire Wire Line
	7150 2850 7100 2850
$Comp
L step_dir_controller_5x3:TERM_BLK_HDR_4POS_VERT_0.138IN T1
U 1 1 58DBDAC6
P 6150 5000
...
F 2 "step_dir_controller_5x3:TERM_BLK_HDR_4POS_VERT_0.138IN" H 6050 5150 50  0001 C CNN
...
$EndComp
$Comp
L step_dir_controller_5x3:HEADER_02X05_SMD P3
U 1 1 58DC6361
P 6850 2750
...
F 2 "step_dir_controller_5x3:HEADER_02x05_SMD" H 6850 1550 60  0001 C CNN
